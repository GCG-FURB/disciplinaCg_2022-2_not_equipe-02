    ...
    private Cone obj_Cone;
      ...
      obj_Cone.Translacao(6, 'x');
        ...
        private Cubo Dice()
        {
            ...
            dado.ObjetoCor.CorR = 255;
            dado.ObjetoCor.CorG = 255;
            dado.ObjetoCor.CorB = 255;

            dado.FilhoAdicionar(DiceCircle(0, 0, -0.5));

            dado.FilhoAdicionar(DiceCircle(-0.5, -0.3, -0.3));
            dado.FilhoAdicionar(DiceCircle(-0.5, 0.3, 0.3));

            dado.FilhoAdicionar(DiceCircle(-0.3, 0.5, -0.3));
            dado.FilhoAdicionar(DiceCircle(0, 0.5, 0));
            dado.FilhoAdicionar(DiceCircle(0.3, 0.5, 0.3));
            ...
            dado.FilhoAdicionar(DiceCircle(0.5, 0.3, 0.3));
            dado.FilhoAdicionar(DiceCircle(0.5, -0.3, 0.3));
            dado.FilhoAdicionar(DiceCircle(0.5, 0, 0));
            dado.FilhoAdicionar(DiceCircle(0.5, 0.3, -0.3));
            dado.FilhoAdicionar(DiceCircle(0.5, -0.3, -0.3));

            dado.FilhoAdicionar(DiceCircle(0.3, -0.3, 0.5));
            dado.FilhoAdicionar(DiceCircle(0.3, 0, 0.5));
            dado.FilhoAdicionar(DiceCircle(0.3, 0.3, 0.5));
            dado.FilhoAdicionar(DiceCircle(-0.3, -0.3, 0.5));
            dado.FilhoAdicionar(DiceCircle(-0.3, 0, 0.5));
            dado.FilhoAdicionar(DiceCircle(-0.3, 0.3, 0.5));
